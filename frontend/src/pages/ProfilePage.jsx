...
export default function ProfilePage() {
  ...
  useEffect(() => {
    api.get('/auth/me').then(res => setInfo(res.data.user)).catch(console.error);
  }, []);
  ...
  return (
    <div style={{
        ...
        {[
          ...
          <div key={label} style={{
            ...
            <span style={{
              ...
              color: mono ? 'var(--accent-blue-light)' : 'var(--text-primary)',
            }}>
              {value || '—'}
            </span>
          </div>
      ...
      <button onClick={logout} style={{
        width: '100%', maxWidth: '340px', padding: '13px',
